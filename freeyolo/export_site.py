...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  .cost { font-family:var(--mono); font-size:10px; font-weight:700; letter-spacing:.05em; padding:2px 7px; border-radius:5px; }
  ...
  .lvl { font-family:var(--mono); font-size:10px; font-weight:700; letter-spacing:.05em; padding:2px 7px; border-radius:5px;
...
<header><div class="wrap">
  ...
  <p class="lede">A living board of free ways to learn, use and understand AI. New here? Start with
    the route below. Watching a deadline? The time-sensitive ones are boarding first.</p>
  <div class="readout">
...
function isNew(r){ return MODE!=='archive' && r.found_at && r.found_at !== MIN_FOUND
